...
PARTICLE_VOLUME = (math.pi / 6.0) * PARTICLE_DIAMETER ** 3
BED_WIDTH = 0.002
CROSS_AREA = BED_WIDTH ** 2
...
def plot(refdata: Path) -> Path:
    ...
    hist_values = [datum['pg'] for datum in refdata]
    ...
    ax3.plot([-len(avg_vals), 0], [1.0320637, 1.0320637], color='k', linewidth=0.5)
