...
To = 2.0d0; % truncate time from startup 
Tb = 2.0d0; % bin averaging window size
...
% print
xc = linspace(11,154,14)' - 11/2; 
fprintf(1,'\n\nx^(i)\t ta mean\t   95%% CI \t ta std\t   95%% CI\n');
for ii = 1:I
  fprintf(1,'%12.6e\t%12.6e\t%12.6e\t%12.6e\t%12.6e\n',xc(ii),muhatX(ii),sighatX(ii),muhatS(ii),sighatS(ii));
end
