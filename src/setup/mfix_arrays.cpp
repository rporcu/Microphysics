...
mfix::RegridArrays (int lev)
{
  ...
  // Void fraction
  MultiFab ep_g_new(grids[lev], dmap[lev], ep_g.nComp(), ep_g.nGrow(),
  ...
  // Old void fraction
  MultiFab ep_go_new(grids[lev], dmap[lev], ep_go.nComp(), ep_go.nGrow(),
                     MFInfo(), *ebfactory[lev]);
  ...
  std::unique_ptr<MultiFab> ro_go_new(new MultiFab(grids[lev],dmap[lev],
                                                   ro_go[lev]->nComp(), ro_go[lev]->nGrow(),
                                                   MFInfo(), *ebfactory[lev]));
