...
contains
   ...
   !                                                                      !
   !----------------------------------------------------------------------!
   subroutine output_manager_aos( np, time, dt, xlength, ylength, zlength, &
        & nstep, particles, finished ) &
        & bind(C, name="mfix_output_manager_aos")
...
2000     FORMAT('Wall Time - ',2(A,1X,A,A,4X))
   ...
   end subroutine output_manager_aos
   ...
   !                                                                      !
   !----------------------------------------------------------------------!
   subroutine output_manager(np, time, dt, &
      ...
      real(c_real), intent(in) :: des_vel_new(np,3)
      real(c_real), intent(in) :: omega_new(np,3)


      integer(c_int), intent(inout) :: particle_state(np)
