                           ...
                           const Box& domain)
{
  ...
  if (nlft > 0)
  {
    amrex::ParallelFor(bx_yz_lo_3D, [bct_ilo,dom_lo,T_g,p_bc_t_g,pout,minf,pinf]
  ...
  if (nrgt > 0)
  {
    amrex::ParallelFor(bx_yz_hi_3D, [bct_ihi,dom_hi,T_g,p_bc_t_g,pout,minf,pinf]
      AMREX_GPU_DEVICE (int i, int j, int k) noexcept
    {
  ...
  if (nbot > 0)
  {
    amrex::ParallelFor(bx_xz_lo_3D, [bct_jlo,dom_lo,T_g,p_bc_t_g,pout,minf,pinf]
      AMREX_GPU_DEVICE (int i, int j, int k) noexcept
    {
  ...
  if (ntop > 0)
  {
    amrex::ParallelFor(bx_xz_hi_3D, [bct_jhi,dom_hi,T_g,p_bc_t_g,pout,minf,pinf]
      AMREX_GPU_DEVICE (int i, int j, int k) noexcept
    {
  ...
  if (ndwn > 0)
  {
    amrex::ParallelFor(bx_xy_lo_3D, [bct_klo,dom_lo,T_g,p_bc_t_g,pout,minf,pinf]
      AMREX_GPU_DEVICE (int i, int j, int k) noexcept
    {
  ...
  if (nup > 0)
  {
    amrex::ParallelFor(bx_xy_hi_3D, [bct_khi,dom_hi,T_g,p_bc_t_g,pout,minf,pinf]
      AMREX_GPU_DEVICE (int i, int j, int k) noexcept
    {
