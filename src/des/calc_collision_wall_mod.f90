...
module calc_collision_wall
   ...
   public :: calc_dem_force_with_wall_stl_aos
...
contains
   ...
   subroutine calc_dem_force_with_wall_stl_aos( particles, fc, tow, xlength, ylength, zlength )
      ...
      do ll = 1, size( particles )
         ...
         associate ( radius => particles(ll) % radius, pos => particles(ll) % pos, &
            ...
            do nf = 1, 6
               ...
               ! Calculate the translational relative velocity
               call cfrelvel_wall_aos(ll, v_rel_trans_norm, vrel_t, normal, distmod, &
                    & particles )
   ...
   end subroutine calc_dem_force_with_wall_stl_aos
   ...
   !  whereas the full tangential vector is returned.                     !
   !----------------------------------------------------------------------!
   subroutine cfrelvel_wall_aos (ll, vrn, vrt, norm, dist, particles )
   ...
   end subroutine cfrelvel_wall_aos
