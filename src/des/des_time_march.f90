...
contains
   ...
   subroutine des_time_loop ( nrp, rparticles, ngp, gparticles, size_nl, &
        nbor_list, tow, fc, subdt, dx, xlength, ylength, zlength, ncoll, stime, &
...
!     deallocate(tow, fc, particles)
   ...
   subroutine des_time_loop_per ( nrp, rparticles, ngp, gparticles, size_nl, &
        nbor_list, tow, fc, subdt, dx, xlength, ylength, zlength, ncoll, stime) &
          bind(C, name="des_time_loop_per")
...
!     deallocate(tow, fc, particles)
   ...
   end subroutine des_time_loop_per
