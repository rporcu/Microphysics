...
!                                                                      !
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^!
subroutine calc_drag_fluid_aos ( slo, shi, ulo, uhi, vlo, vhi, wlo, whi,     &
     np, ep_g, ro_g, u_g, v_g, w_g, mu_g, f_gs, rhs, particles, dx, dy, dz ) &
     bind(C, name="calc_drag_fluid_aos")
...
end subroutine calc_drag_fluid_aos
...
!                                                                      !
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^!
subroutine calc_drag_particle_aos( slo, shi, ulo, uhi, vlo, vhi, wlo, whi, &
     np, p_g, u_g, v_g, w_g, particles, dx, dy, dz, xlen, ylen, zlen )&
     bind(C, name="calc_drag_particle_aos")
...
end subroutine calc_drag_particle_aos
