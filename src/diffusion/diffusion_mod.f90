         ...
         do n = 1, 3
            do k = lo(3), hi(3)
               do j = lo(2), hi(2)
                  ...
                  else if ( bc_ilo_type(j,k,1) == POUT_) then
         ...
         do n = 1, 3
            do k = lo(3), hi(3)
               do j = lo(2), hi(2)
                  ...
                  else if ( bc_ihi_type(j,k,1) == POUT_) then
         ...
         do n = 1, 3
            do k = lo(3), hi(3)
               do i = lo(1)-1, hi(1)+1
                  ...
                  else if ( bc_jhi_type(i,k,1) == POUT_) then
         ...
         do n = 1, 3
            do j = lo(2)-1, hi(2)+1
               do i = lo(1)-1, hi(1)+1
                  ...
                  else if ( bc_klo_type(i,j,1) == POUT_) then
         ...
         do n = 1, 3
            do j = lo(2)-1, hi(2)+1
               do i = lo(1)-1, hi(1)+1
                  ...
                  else if ( bc_khi_type(i,j,1) == POUT_) then
