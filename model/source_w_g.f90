...
! modifications for bc
      CALL SOURCE_W_G_BC (slo, shi, lo, hi, A_m, b_m, w_g, wlo, whi, flag, dx, dy, dz)
...
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^C
      ...
      SUBROUTINE SOURCE_W_G_BC(slo,shi,lo,hi,A_m, b_m, w_g, wlo, whi, flag, dx, dy, dz)
...
!                                                                      C
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^C
      SUBROUTINE POINT_SOURCE_W_G(slo, shi, lo, hi, A_m, b_m, wlo, whi, flag, dx, dy, dz)
