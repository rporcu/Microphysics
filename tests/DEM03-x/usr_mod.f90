...
!  page 22, Equation (67).                                             !
!......................................................................!
      subroutine rk4_v4(DT, y1_a, x1_a, y2_a, x2_a, xlength)

      implicit none

      real(c_real), intent(in   ) :: dt, xlength
      ...
      x2_K1 = DT * (F2b+F2kw(y2,xlength)+F2dw(x2)+F21k(y1,y2)+F21d(x1,x2))
      ...
      x2_K2 = DT * (F2b+F2kw(y2,xlength)+F2dw(x2)+F21k(y1,y2)+F21d(x1,x2))
      ...
      x2_K3 = DT * (F2b+F2kw(y2,xlength)+F2dw(x2)+F21k(y1,y2)+F21d(x1,x2))
      ...
      x2_K4 = DT * (F2b+F2kw(y2,xlength)+F2dw(x2)+F21k(y1,y2)+F21d(x1,x2))
