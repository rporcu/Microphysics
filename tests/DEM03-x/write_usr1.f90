...
! !                                                                      C
! !^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^C
!       subroutine write_usr1(l, time, dt, np, des_pos_new, des_vel_new, omega_new, &
...
!       SELECT CASE(L)
!       CASE(1); call write_des_out(TIME, np, des_pos_new, des_vel_new, &
!                                   xlength)
!       end SELECT
...
! !  https://mfix.netl.doe.gov/documentation/dem_doc_2012-1.pdf,         !
! !......................................................................!
!       subroutine write_des_out(lTime, np, des_pos_new, des_vel_new, length)
