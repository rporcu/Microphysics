...
! Write the results to file.
      WRITE(lUNIT,1000) lTime, RK4_POS(1), DES_POS_NEW(1,1),           &
         ABS_ERR(RK4_POS(1), DES_POS_NEW(1,1))
...
! Open the file.
      OPEN(UNIT=lUNIT, FILE='POST_VEL.dat',                            &
         POSITION="APPEND", STATUS='OLD')
! Write the results to file.
      WRITE(lUNIT,1000) lTime, RK4_VEL(1), DES_VEL_NEW(1,1),           &
         ABS_ERR(RK4_VEL(1), DES_VEL_NEW(1,1))
! Close the output file.
      CLOSE(lUNIT)
