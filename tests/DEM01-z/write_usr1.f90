...
subroutine WRITE_DES_Out(lTime, np, particles)
   ...
   write(uPos,"(F15.8,5x,I1,5X,F15.8,3(3x,F15.8))") lTime, lStage, lPos_Y, particles(1)%pos(3)
   close(uPos)


   write(uVel,"(F15.8,5x,I1,5X,F15.8,3(3x,F15.8))") lTime, lStage, lVel_Y, particles(1)%vel(3)
   close(uVel)
