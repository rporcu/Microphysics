...
void
mfix::Regrid (int base_lev, int nstep)
{
    ...
    // mfix::RegridArrays, which only acts on the fluid grid) because of a
    // dual grid: the level-set factory object regrids using the
