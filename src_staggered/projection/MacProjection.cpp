...
// // 
// void
// get_phi ( Vector< std::unique_ptr<MultiFab> >& a_phi )
// {
//     a_phi = m_phi;
...
// 
void
MacProjection::compute_divepu (  Vector< std::unique_ptr<MultiFab> >& u,
				 Vector< std::unique_ptr<MultiFab> >& v,
				 Vector< std::unique_ptr<MultiFab> >& w,
				 Vector< std::unique_ptr<MultiFab> >& ep,
				 const Real c = 1.0 )
